    ...
    <div className="bg-[#1a1d26] border border-gray-800 rounded-xl p-4 space-y-2">
      ...
      <p className="text-xs text-gray-400 flex items-center gap-1">Booked for {booking.total_days} days</p>
       <p className="text-xs text-gray-400 flex items-center gap-1">Booked By User: {booking.user_name} </p>
        <p className="text-xs text-gray-400 flex items-center gap-1"> User's Phone Number: {booking.user_contact_number} </p>
        <p className="text-xs text-gray-400 flex items-center gap-1">Car Owner's Name: {booking.owner_name} </p>
      <p className="text-xs text-gray-400 flex items-center gap-1">Car Owner's Contact Number: {booking.owner_contact_number}</p>
